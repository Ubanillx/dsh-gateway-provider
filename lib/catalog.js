 ...
 */
export function normalizeInputModalities(raw) {
  ...
  return entries
    ...
    .map((e) => {
      ...
      return {
        ...
        ...Array.isArray(ov.inputModalities) && ov.inputModalities.length > 0 ? { input: normalizeInputModalities(ov.inputModalities) } : {},
      };
    });
}
  ...
  return raw
    ...
    .map((m) => {
      ...
      return {
        ...
        image: (entry.input || []).includes("image"),
      };
    });
}
